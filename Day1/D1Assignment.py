...
Multiplication=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),text="*",command=lambda:btnClick("*")).grid(row=3,column=3)

btn0=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),text="0",command=lambda:btnClick(0)).grid(row=4,column=0)
Modulus=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),text="%",command=lambda:btnClick("%")).grid(row=4,column=1)
Exponentiation=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),text="**",command=lambda:btnClick("**")).grid(row=4,column=2)
Division=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),text="/",command=lambda:btnClick("/")).grid(row=4,column=3)

btnDot=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),text=".",command=lambda:btnClick(".")).grid(row=5,column=0)
btnClear=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),text="C",command=btnClearDisplay).grid(row=5,column=1)
btnEquals=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),text="=",command=btnEqualsInput).grid(row=5,column=2)
FloorDivision=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),text="//",command=lambda:btnClick("//")).grid(row=5,column=3)
